...
# replaced = (line[line.find(marker):line.find(marker)+(len(marker))])
# print(replaced)

# CORRECT SOLUTION

# index = line.find(marker)
# replaced = line[:index] + replacement + line[len(marker)+index:]
# line = replaced
# print (line)
...
length = len(marker)
start_of_replacemnt = (line.find(marker))
end_of_replacemnt = start_of_replacemnt + length
replaced = line[:start_of_replacemnt] + replacement + line[end_of_replacemnt:]
line = replaced
print(line)
