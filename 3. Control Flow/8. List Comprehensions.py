...
# The code above sets squares equal to the list [0, 4, 16, 36, 64], as x to the power of 2
# is only evaluated if x is even. If you want to add an else, you will get a syntax error doing this.
