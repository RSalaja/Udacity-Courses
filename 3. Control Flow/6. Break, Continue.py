...
# that is exactly 140 characters long. You should create the news ticker by
# adding headlines from the headlines list, inserting a space in between each headline.
...
print("New News Ticker:\n{} \nLength of the str: {}".format(news_ticker,len(news_ticker)))
