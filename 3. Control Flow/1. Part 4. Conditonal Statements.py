...
# prizes they won based on the number of points they scored, which is stored in the integer variable points.
...
# If they've won a prize, the message should state "Congratulations! You won a [prize name]!"
# with the prize name. If there's no prize, the message should state "Oh dear, no prize this time."
...
# Store this number in a variable called 'answer'. Another user provides a number called
# 'guess'. By comparing guess to answer, you inform the user if their guess is too high or too low.
...
# '''
answer = 12  # provide answer
guess = 16  # provide guess
