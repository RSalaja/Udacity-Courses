...
# In the code editor below, you'll find a dictionary containing
# the unique words of verse stored as keys and the number of times
# they appear in verse stored as values. Use this dictionary to answer
