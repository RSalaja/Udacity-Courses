...
# by commas (here, height and radius). Arguments, or parameters,
# are values that are passed in as inputs when the function is called, and are used in the function body.
...
# 1. The body of a function is the code indented after the header line.
# Here, it's the two lines that define pi and return the volume.

# 2. Within this body, we can refer to the argument variables and define new variables,
# which can only be used within these indented lines.

# 3. The body will often include a return statement, which is used to send back an output
# value from the function to the statement that called the function.
# A return statement consists of the return keyword followed by an expression that is evaluated
# to get the output value for the function. If there is no return statement, the function simply returns None.

# Naming Conventions for Functions
# Function names follow the same naming conventions as variables.

# Only use ordinary letters, numbers and underscores in your function names.
...
# Test run this code and experiment to understand the difference.
