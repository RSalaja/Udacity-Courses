...
# QUIZ: REPLACE SPY
# Define a procedure, replace_spy, that takes as
# its input a list of three
# numbers and increases the value of the third element
# of the list to be one more than its previous value.
